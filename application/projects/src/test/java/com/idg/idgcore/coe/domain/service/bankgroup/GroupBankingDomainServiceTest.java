...
import com.idg.idgcore.coe.app.service.bankgroup.GroupBankingApplicationService;
...
class DomainServiceTest {
   ...
   //     AbstractAuditableDomainEntity abstractAuditableDomainEntity = getAbstractAuditableDomainEntity();
    ...
    void getGroupBankByCodeReturnEntity() {
        ...
        GroupBankingEntity groupBankByCode = groupBankingDomainService.getGroupBankByCode(groupBankingEntity.getBankGroupCode());
    ...
    void getConfigurationByCodeReturnsQuestionEntity(){
        ...
        given(iGroupBankingRepository.findByBankGroupCode("CBI")).willReturn(groupBankingEntity);
        GroupBankingEntity groupBankingEntity = groupBankingDomainService.getConfigurationByCode(groupBankingDTO);
    ...
    void getGroupBankByCodeReturnQuestionEntityObject(){
        ...
        given(iGroupBankingRepository.findByBankGroupCode("CBI")).willReturn(groupBankingEntity);
        GroupBankingEntity groupBankByCode1 = groupBankingDomainService.getGroupBankByCode(groupBankingEntity.getBankGroupCode());
    ...
    void getGroupBanksReturnQuestionEntityObject() {
        groupBankingEntity = new GroupBankingEntity();
        groupBankingEntity.setBankGroupCode("CBI");
        groupBankingEntity.setBankGroupCode("Central Bank of India");

        given(iGroupBankingRepository.findAll()).willReturn(Collections.emptyList());
        List<GroupBankingEntity> questionEntityList = groupBankingDomainService.getGroupBanks();
    ...
    void getBanksGroupReturnListOfGroupBanks(){
        ...
        List<GroupBankingEntity> questions = groupBankingDomainService.getGroupBanks();
    ...
    void BankGroupReturnTrue() {
        ...
        groupBankingDTO.setBankGroupCode("CBI");
        groupBankingDTO.setBankGroupName("Central Bank of India");
        given(groupBankingAssembler.convertDtoToEntity(groupBankingDTO)).willReturn(groupBankingEntity);
