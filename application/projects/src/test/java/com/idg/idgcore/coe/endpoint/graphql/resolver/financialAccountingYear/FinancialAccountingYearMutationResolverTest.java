...
class FinancialAccountingYearMutationResolverTest {
    ...
    void processFinancialAccountingYearSaveDraftToNewReject() throws IOException, JSONException {
        ...
        //        assertEquals(FileReaderUtil.read("response/financialAccountingYear/success-response-finAccYear.json"),graphQLResponseAuthUpdated.getRawResponse().getBody(), true);
    ...
    void processFinancialAccountingYearSaveCloseToClosed() throws IOException, JSONException {
        ...
        //        assertEquals(FileReaderUtil.read("response/financialAccountingYear/success-response-finAccYear.json"),graphQLResponseCkReopen.getRawResponse().getBody(), true);
