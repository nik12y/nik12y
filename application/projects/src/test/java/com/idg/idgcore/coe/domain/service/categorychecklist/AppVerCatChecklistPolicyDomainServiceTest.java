...
class AppVerCatChecklistPolicyDomainServiceTest {
    ...
    void getAppVerCategoryConfigsReturnStatesList() {
        ...
        List<AppVerCatChecklistPolicyEntity> appVerCatChecklistPolicyEntityList = appVerCatChecklistPolicyDomainService.getAllEntities();
    ...
    void getgetAppVerCategoryConfigByIdReturnStateEntityObject() {
        ...
        AppVerCatChecklistPolicyEntity appVerCatChecklistPolicyEntity1 =
                appVerCatChecklistPolicyDomainService.getEntityByIdentifier(
                        appVerCatChecklistPolicyEntity.getAppVerChecklistPolicyId());
    ...
    void getConfigurationByCodeCatchBlock() {
        assertThrows(BusinessException.class,()-> {
            appVerCatChecklistPolicyDomainService.getEntityByIdentifier(null);
        });
    }
