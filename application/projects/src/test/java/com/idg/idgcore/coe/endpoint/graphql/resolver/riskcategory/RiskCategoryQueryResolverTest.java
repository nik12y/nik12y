...
class RiskCategoryQueryResolverTest {
    ...
    void getBranchTypeByCodeQuery() throws IOException, JSONException {
        ...
        GraphQLResponse graphQLResponse = graphQLTestTemplate.postForResource("request/riskcategory/query-riskcategory-bycode.graphqls");
    ...
    void getBranchesQuery() throws IOException, JSONException {
        ...
        GraphQLResponse graphQLResponse = graphQLTestTemplate.postForResource("request/riskcategory/query-riskcategories.graphqls");
        assertThat(graphQLResponse.isOk(), equalTo(true));
