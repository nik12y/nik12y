package com.idg.idgcore.coe.app.service.branchSystem;
...
//        branchSystemEntity = getBranchSystemDateAllEntity();
...
//        branchSystemEntity1 = getBranchSystemDateAllEntity();
//        branchSystemEntity2 = getBranchSystemDateAllEntity2();
...
//        given(mutationsDomainService.getConfigurationByCode(branchSystemDateDTO6.getTaskIdentifier())).willReturn(mutationEntity6);
        ObjectMapper mockObjectMapper = mock(ObjectMapper.class);
        PayloadDTO payload6 = new PayloadDTO();
//        Mockito.when(mockObjectMapper.readValue(payload6.getData(), BranchSystemDateDTO.class)).thenReturn(branchSystemDateDTO6);
//        given(branchSystemAssembler.setAuditFields(mutationEntity6, branchSystemDateDTO6)).willReturn(branchSystemDateDTO6);
//        Assertions.assertThrows(FatalException.class, () -> {
//            BranchSystemDateDTO branchSystemDateDTO1 = branchSystemApplicationService.getBranchSystemDateByCode(sessionContext, branchSystemDateDTO6);
...
//    @Test
//    @DisplayName("JUnit for getByBranchCode in application service when Not Authorize in try else block")
//    void getBranchSystemDateByCodewhenNotAuthorizeTryBlock() throws JsonProcessingException, FatalException {
//        given(mutationsDomainService.getConfigurationByCode(branchSystemDTOUnAuth.getTaskIdentifier())).willReturn(mutationEntity);
//
//        String payLoadString= "{\"action\":\"draft\",\"status\":\"draft\",\"recordVersion\":0," +
//                "\"authorized\":\"N\",\"lastConfigurationAction\":\"draft\",\"taskCode\":\"BRANCH_SYSTEM_DATE\"," +
//                "\"taskIdentifier\":\"BC0002\",\"branchCode\":\"BC0001\",\"currentWorkingDate\":\"12-02-2022\"," +
//                "\"previousWorkingDate\":\"12-01-2022\",\"nextWorkingDate\":\"15-08-2022\"}";
//
//        ModelMapper mapper=new ModelMapper();
//        PayloadDTO payload = new PayloadDTO(payLoadString);
//        ObjectMapper mockObjectMapper = mock(ObjectMapper.class);
//        PayloadDTO helper = org.mockito.Mockito.mock(PayloadDTO.class);
//        BranchSystemDateDTO branchSystemDateDTO = branchSystemApplicationService.getBranchSystemDateByCode(sessionContext,branchSystemDTOMapper);
...
//                     Mockito.when(mockObjectMapper.readValue(mutationEntity.getPayload().getData(), StateDTO.class)).thenReturn(stateDTO);
    ...
    void getgetBranchSystemDateAllCatchBlockForChecker() throws JsonProcessingException, FatalException {
...
//    private BranchSystemDateEntity getBranchSystemDateAllEntity(){
//        BranchSystemDateEntity branchSystemEntity = new BranchSystemDateEntity("BC0002", "07-08-2022", "05-08-2022", "10-08-2022");
//
//        return branchSystemEntity;
//    }

//    private BranchSystemDateEntity getBranchSystemDateAllEntity2()
//    {
//        BranchSystemDateEntity branchSystemEntity2 = new BranchSystemDateEntity();
//        branchSystemEntity2.setBranchCode("BC0002");
//        branchSystemEntity2.setCurrentWorkingDate("07-08-2022");
//        branchSystemEntity2.setPreviousWorkingDate("07-08-2022");
//        branchSystemEntity2.setNextWorkingDate("10-10-2022");
//        branchSystemEntity2.setAuthorized("N");
//        branchSystemEntity2.setStatus("closed");
//        branchSystemEntity2.setRecordVersion(1);
//        return branchSystemEntity2;
//    }
